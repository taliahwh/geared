...
const OrderReceiptScreen = ({
  ...
  const [leaveFeedbackModalVisible, setLeaveFeedbackModalVisible] =
    useState(false);
    ...
    ActionSheetIOS.showActionSheetWithOptions(
      {
        ...
        tintColor: '#000',
        message:
          'Before you leave feedback, make sure that you have received and checked your item. Feedback is final and cannot be changed. Remember to be friendly and to be fair.',
      },
      (buttonIndex) => {
        if (buttonIndex === 0) {
          // cancel action
        } else if (buttonIndex === 1) {
          setLeaveFeedbackModalVisible(true);
        }
      }
    );
  };
  ...
  return (
    <>
        ...
        <View style={styles.modalView}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.sellerInfoContainer}>
              ...
              />
              <Text style={styles.purchasedOnText}>
                Purchased on 8/29/22 from
              </Text>
      ...
      <TouchableOpacity onPress={openActionSheet} activeOpacity={0.8}>
        <View style={styles.leaveFeedbackContainer}>
          <View style={styles.btnContainer}>
            <Text style={styles.leaveFeedbackBtn}>Leave feedback</Text>
          </View>
        </View>
      </TouchableOpacity>
      ...
      <Modal
        animationType="fade"
        transparent={true}
        visible={leaveFeedbackModalVisible}
        onRequestClose={() => {
          console.log('Modal has been closed.');
          setLeaveFeedbackModalVisible(!leaveFeedbackModalVisible);
        }}
      >
        <LeaveFeedbackScreen
          hideModal={() => setLeaveFeedbackModalVisible(false)}
          sellerName={'Abigail'}
          sellerUsername={'buy_thebook'}
          sellerProfileImage={
            'https://media-s3-us-east-1.ceros.com/hour-media/images/2020/02/22/1515b62a44354747dbe7bdb92fcad03e/usatsi-13976425-scaled.jpg?imageOpt=1&fit=bounds&width=617'
          }
        />
      </Modal>
    </>
